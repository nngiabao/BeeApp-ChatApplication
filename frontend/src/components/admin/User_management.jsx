...
export default function UserManagement() {
    ...
    const handleToggleOnline = async (user) => {
        ...
        await fetch(`${import.meta.env.VITE_API_URL}/users/${user.isOnline ? "logout" : "login"}`, {
            method: "POST",
    ...
    const handleDeleteUser = async () => {
        await fetch(`${import.meta.env.VITE_API_URL}/users/${contextMenu.user.id}`, { method: "DELETE" });
        fetchUsers();
        setContextMenu({ ...contextMenu, visible: false });
    };
